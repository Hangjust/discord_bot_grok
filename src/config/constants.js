...
const botHelpCommandName = '!bot help';
const channelEnableCommandName = 'channelenable';
const channelDisableCommandName = 'channeldisable';
...
const profileStopWords = new Set([
  ...
  'could', 'didn', 'does', 'don', 'from', 'grok', 'have', 'just', 'like',
  'more', 'or', 'stats', 'that', 'their', 'them', 'then', 'there', 'they',
  'this', 'with', 'what', 'when', 'where', 'will', 'would', 'your',
]);
const readExcludedChannelIds = Object.freeze([
  '1510012659070669021', '1490104641567064171', '1490104641567064174',
  '1490124838768087192', '1490789519723598104', '1493350585573838848',
  '1504209869215895593', '1490111513585782926', '1490140728872145028',
  '1490104641567064168', '1490104641567064166', '1510025163964416130',
  '1490148514918039673',
]);
const replyAllowedChannelIds = Object.freeze([
  '1500987717125800027', '1510014757103472640', '1510014487732813975',
  '1497039482954715166', '1512855384459706438',
]);
